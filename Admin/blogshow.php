                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" name="form" action="RemoveBlog.php">
                                                        <input type="hidden" name="new" value="1" />
                                                        <input name="id" type="hidden" value="<?php echo $row['blog_id'];?>" />
